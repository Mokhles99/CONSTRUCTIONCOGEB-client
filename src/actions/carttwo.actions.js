...
export const addToCarttwo = (cartId, productId, quantity = 1) => async (dispatch) => {
    ...
    try {
        const response = await fetch(`http://localhost:3005/carttwo/${cartId}/add`, {
            method: 'POST',
...
export const getCarttwo = (cartId) => async (dispatch) => {
    ...
    try {
        const response = await fetch(`http://localhost:3005/carttwo/${cartId}/getCarttwo`, {
            method: 'GET'
        });
        const data = await response.json();
...
export const updateCartWithUserInfo = (cartId, userInfo) => async (dispatch) => {
    ...
    try {
        const response = await fetch(`http://localhost:3005/carttwo/${cartId}/userinfo`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
export const removeItemFromCart = (cartId, itemId) => async (dispatch) => {
    ...
    try {
        const response = await fetch(`http://localhost:3005/carttwo/${cartId}/items/${itemId}`, {
            method: 'DELETE'
        });
        if (!response.ok) {
...
export const getAllCarts = () => async (dispatch) => {
    ...
    try {
        const response = await fetch('http://localhost:3005/carttwo/all');
        const data = await response.json();
        if (response.ok) {
...
//     dispatch({ type: carttwoConstants.ADD_TO_CARTTWO_REQUEST });
//     try {
//         const response = await fetch('http://localhost:3005/carttwo/cart/add', {
//             method: 'POST',
//             headers: { 'Content-Type': 'application/json' },
//             body: JSON.stringify({ productId, quantity })
//         });
...
//     dispatch({ type: carttwoConstants.GET_CARTTWO_REQUEST });
//     try {
//         const response = await fetch('http://localhost:3005/carttwo/getCarttwo');
//         const data = await response.json();
//         dispatch({ type: carttwoConstants.GET_CARTTWO_SUCCESS, payload: data });
//     } catch (error) {
//         dispatch({ type: carttwoConstants.GET_CARTTWO_FAILURE, payload: error.message });
