...
const thirdImageUrl = abouts.length > 2 && abouts[2].files.length > 0
  ...
  >
    Fondée en 1980, COGEB se spécialise dans la vente de matériel et de
    produits de construction. Leader dans ce domaine, elle propose divers
    produits, répondant aux besoins des professionnels et des particuliers.
  </p>
  ...
  <div className="lg:block hidden">
    ...
    <div className="bg-white shadow-2xl px-4 py-6 rounded-3xl flex items-center gap-x-3 lg:w-4/5 mt-6">
      ...
      <div className="lg:w-1/2 flex items-end gap-4 lg:mt-0 mt-12 lg:h-auto h-[40rem]">
        <img
          // src="/assets/proposconst11.png"
          src={firstImageUrl ||"/assets/proposconst11.png"}
          alt=""
          className="rounded-3xl w-1/2 h-4/5 shadow-md object-cover"
        />
        <div className="w-1/2 h-4/5 flex flex-col gap-4 relative -top-20">
          <img
            // src="/assets/proposconst21.png"
            src={secondImageUrl || "/assets/proposconst21.png"}
            alt=""
            className="w-full h-3/5 rounded-3xl shadow-md object-cover"
          />
          <img
            // src="/assets/briqueboispropos 1.png"
            src={thirdImageUrl || "/assets/briqueboispropos 1.png" }
            alt=""
