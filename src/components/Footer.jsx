...
const Footer = () => {
  return (
    <footer>
          ...
          <div className="lg:flex justify-between px-3 w-full py-12 lg:text-left text-center">
            ...
            <div className="lg:w-1/3">
              ...
              <div className="relative h-14 flex justify-center items-center">
                ...
                />
                <button className="bg-[#576D80] text-white rounded-full w-12 h-12 flex justify-center items-center text-xl absolute right-1">
                  <IoArrowForward />
                </button>
              </div>
              <p className="font-semibold py-6 text-lg lg:text-left text-center">Follow Us on</p>
              <span className="text-[#576D80] flex items-center gap-4 text-2xl lg:justify-normal justify-center">
      ...
      <section className="lg:block hidden bg-[#576D80] text-[#7b7a7a] xl:text-base text-sm">
